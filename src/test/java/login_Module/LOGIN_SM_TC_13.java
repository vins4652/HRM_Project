...
public class LOGIN_SM_TC_13 {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 * assistantusername hrassistant@gmail.com
		 * assistantpassword hrassistant@123
		 * assistantselect_type HR Assistant
		 */
		String userName = pObj.getProperty("assistantusername");
		String password = pObj.getProperty("assistantpassword");
		String selecttype = pObj.getProperty("assistantselect_type");
