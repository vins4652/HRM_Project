...
public class Create_Employee_as_Head extends BaseClass {

	@Test
	public void create_Employee_as_Head()  throws IOException {
		
		// Triggering the test url and get the page displayed
...
//			Reporter.log("The Corporation is sucessfully created");
//		} else {
//			Reporter.log("The Corporation is not created");
//		}
...
//		}
		...
		String expectedAddEmployeePopupTitle = xLib.getExpectedDataFromExcel("expdata", "expectedAddEmployeePopupTitle");
